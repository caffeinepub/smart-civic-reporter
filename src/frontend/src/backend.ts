...
import type { ExternalBlob as _ExternalBlob, Issue as _Issue, IssueStatus as _IssueStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitIssue(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitIssue(arg0, arg1, arg2, arg3, await to_candid_opt_n20(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateIssueStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_IssueStatus_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _IssueStatus): IssueStatus {
    return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
async function from_candid_Issue_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Issue): Promise<Issue> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_IssueStatus_n16(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "resolved" in value ? IssueStatus.resolved : "pending" in value ? IssueStatus.pending : "inProgress" in value ? IssueStatus.inProgress : value;
}
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Issue>): Promise<Array<Issue>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Issue_n14(_uploadFile, _downloadFile, x)));
}
